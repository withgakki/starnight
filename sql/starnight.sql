...
CREATE TABLE `t_exam_paper`  (
  ...
  `del_flag` bit(1) NULL DEFAULT NULL COMMENT '删除标志位',
...
CREATE TABLE `t_exam_paper_answer`  (
  `id` bigint(11) NOT NULL AUTO_INCREMENT COMMENT '自增id',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间（提交时间）',
  `create_by` bigint(11) NULL DEFAULT NULL COMMENT '创建者id',
...
CREATE TABLE `t_subject`  (
  ...
  `item_order` int(11) NULL DEFAULT NULL COMMENT '排序字段',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '学科表' ROW_FORMAT = COMPACT;
...
CREATE TABLE `t_user_event_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户操作事件表' ROW_FORMAT = COMPACT;
